    ...
    switch (variant) {
      ...
      case 'giveaway':
        return {
          ...
          icon: (
            <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mb-4 mx-auto" style={{ animation: 'pulse 3s infinite' }}>
