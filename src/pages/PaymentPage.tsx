          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="text-center md:text-left mb-4 md:mb-0">
                <h3 className="text-xl font-bold text-white mb-2">Complete Your Rental with the App</h3>
                <p className="text-csfloat-light/80">
                  Download the Skinforge app to complete your rental and participate in weekly giveaways!
                </p>
              </div>
